...
// console.log('프로그램이 시작되었습니다.'; ')' expected.ts(1005)  <- 구문오류
// if () {} Expresstion expected
...
// +) null 값을 연산하거나 null값에 대한 접근을 하는 경우 런타임 오류 발생
...
try {
  ...
  //  - message 사람이 읽을 수 잇는 형태의 에러 내용이 담김
