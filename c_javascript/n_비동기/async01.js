...
// >> setTimeout()은 비동기 함수
//    : 백그라운드에서 작업이 수행 - 기존의 코드 흐름을 방해하지 않는다.

console.log('비동기 작업 시작');
asyncWork();
console.log('비동기 작업 완료후 실행 '); // setTimeout의 비동기 성질로 asyncWork()보다 먼저 출력
