//! OpenWeatherApi
// : 실시간 날씨 정보를 제공해주는 API (일부 무료 사용 가능)
// Weather 연습용 main.hs

//
const apiKey = "124ffc40501b9c1e7bce8bbd15655221";
const lang = "kr";
const lang2 = "jp";
...
/*
  ...
  ? appid: OpenWeatherMap에서 발급받은 API키 (요청 인증용)     
  ? lang: 언어 설정 (한국어 응답)
...
function displayWeather(data){
  ...
  <p>현재 온도(気温) : ${data.main.temp}</p>
  <p>체감 온도(体感気温) : ${data.main.feels_like} </p>
  <p>날씨(天気) : ${data.weather[0].main} (${data.weather[0].description})</p>
  `
}
