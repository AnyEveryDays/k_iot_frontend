...
let nullTyle: null = null; // 어노테이션 타입 주석을 사용한 타입 강화 시!
// nullType = 'hello'; 지정된 값만 사용가능하다.
nullTyle = null;
