...
console.log(arrowFunc('손태경'));
console.log(arrowFunc('이창하'));
...
//? Rest 나머지 매개변수
// : 함수에 전달하는 여러개의 매개변수를 그룹화하여 배열로 전달하는 방법
// - ...연산자를 사용하여 매개변수명 앞에 첨부
function sum(a: number, b:number, ...c:number[]){
  return c.reduce((c1, c2) => c1 + c2, 0);  // ,뒤의 갚으로 고정시킴?
