...
const student1 = new Student('손태경', 29); //this.name === '손태경'
student1.greet('최광섭'); // name = '최광섭'
// 왜 greet가 name이고 new Student쪽이 this.name으로 가는지 복습해라
...
// - 같은 이름으로 중복 선언 불가
type B = { a:string}
// type B = { b:string} - Duplicate indetifier 'B'
