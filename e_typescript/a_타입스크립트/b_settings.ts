...
// > node -v
//   npm -v
//  "내부 또는 외부 명령, 실행할 수 있는 프로그램(재설치 필요)"
...
//   "main": "index.js",     //? 진입점 JS파일 (빌드 결과 기준)
...
//# 3. typescript 설치
// : 타입스크립트 설치 (npm 사용)
// > 타임스크립트 사용을 위해서는 로컬 | 전역 환경에 TS 설치가 필수

//? npm을 사용하여 '타임스크립트 패키지' 설치
// - 전역 설치('g' 옵션, global)
//  : 개발자 컴퓨터 전체에 기능 추가
...
//        : 로컬의 실행 파일을 찾아서 실행 전역 설치
//          (타입 스크립트 전역 설치 완료 시 tsc --init 만 입력해도 가능)
