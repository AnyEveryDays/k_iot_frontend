...
// 학생 추가 예제
gradeSystem.addStudent('손태경', {Math: 90, English: 85, Social: 90});
gradeSystem.addStudent('이도경', {Math: 70, English: 85, Social: 90});
gradeSystem.addStudent('조승범', {Math: 90, English: 80, Social: 90});
gradeSystem.addStudent('김명진', {Math: 90, English: 83, Social: 79});
