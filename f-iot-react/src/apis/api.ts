// api.ts
// : 서버와 통신하는 API 호출관련 로직 정의 (코드 재사용 및 모듈화)
...
// : 환경 변수
// - REACT 앱에서 API서버의 기본 URL 같은 설정값을 외부에서 주입받을 때 사용

export const api: AxiosInstance = axios.create({
  baseURL: API_BASE,
  timeout: 10000,   //10초 타입아웃 -요청이 10초 이상 걸릴 경우 자동으로 요청취소 + 타임아웃 에러
  headers: {
...
//! 응답 인터셉터: 401(Unauthorized: 자격 증명
