...
//    EX) https://api.example.com/users = 백엔드경로 REST API
...
//    EX) Context-Type
//# - Body: 실제 응답 데이터
//    EX) { "name": "손태경", "email": "stk9460@naver.com"}
...
/*
  ...
  401 Unauthorized  인증실패 - 로그인 토큰이 없거나 잘못됨
  403 Forbidden     권한없음 - 권한이 부족함
...
// >> PATCH를 모든 API에서 지원하지 않는다(X)
//    : 일부 오래된 시스템 또는 프레임워크 PATCH를 지원하지 X - PUT으로 통일하여 사용
