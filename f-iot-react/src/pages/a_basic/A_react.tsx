...
- 전체적인 시스템(기능 일부만 제공이 아니라 프로그램의 구조와 흐름 전체를 제공)
- 프레임워크가 개발자를 제어한다.(개발자가 정해진 규칙 안에서 코드 작성)
: 일정한 형태와 기능을 갖추고 있는 기반 구조( MVC패턴(모델, 뷰, 컨트롤러))
...
: 기능별 모듈의 집합체/ 필요로 할 때 가져와서 사용 가능
