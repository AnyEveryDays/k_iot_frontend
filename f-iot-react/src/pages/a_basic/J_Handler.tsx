...
// : 부모 컴포넌트에서 속성(props)로 message값과 해당 컴포넌트 태그들 사이의 내용을 전달
//# 자식 컴포넌트
...
function J_Handler() {
  ...
  /*
    ...
    1)on-시작
      : props로 전달되는 이벤트 핸들러 (이벤트 바인딩 용)
      - 컴포넌트 외부에서 전달받는 이벤트 핸들러
      EX) onButtonClick, onFormSubmit
    2) -Handler | handler-
      : 내부 함수 (실제 처리 함수)
      - 내부에서 정의된 로직 함수
      EX) buttonClickHandler, fromSubmitHandler
  ...
  */
  ...
  return (
    <div>
      ...
      <hr />
      <ConsoleButton message='A버튼 클릭'>A 버튼</ConsoleButton>
      <ConsoleButton message='B버튼 클릭'>B 버튼</ConsoleButton>
