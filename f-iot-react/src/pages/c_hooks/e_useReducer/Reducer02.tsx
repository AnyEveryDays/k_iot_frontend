  ...
  return (
    <div>
      ...
      {/* 
        dispatch 함수에 () => 첨부 이유
        //  : 즉시 실행 방지
        //  - reducer는 개발자가 직접 호출하느 ㄴ것이 아니라, React가 내부적으로 호출
        //    (지연 실행)
      */}
      <button onClick={() => stepDispatch({ type: 'increment'})}>+2증가</button>
      <button onClick={() => stepDispatch({ type: 'decrement'})}>-2감소</button>
