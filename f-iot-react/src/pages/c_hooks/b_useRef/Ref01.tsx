...
function Ref01() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //& 9) 일반 변수에 데이터 수정
    // : 함수 안에 지역 변수 변경( 렌더링 함수 내부에만 존재, 화면과 연결 X)
  ...
  return (
    <div>
      ...
      {/* 
        ※ 콘솔에는 lengthVar가 계속 찍히지만, 화면에는 반응하지 않음
        >> 실제로 화면이 렌더링 될 때는 이미 새로운 값(0)으로 다시 초기화 된 상태
      */}
      {/* //* 16) 값의 유지 X: 0 출력 */}
